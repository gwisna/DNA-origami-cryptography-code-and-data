...
close all;
%opening file
locs1 = h5read('0_3_cuboctahedron_DNA-PAINT.hdf5', '/locs');
...
limit_gradient=-0.055 %for 0(3) letter<-------------------------------limit for gradient of elbow
%limit_gradient=-0.033 %for 4(2) letter
 for j=1:cluster_trial-1
...
if decoded(group_id,1)==0 && decoded(group_id,2)==3
